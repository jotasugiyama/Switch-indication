      ...
      <?php foreach($accesss as $access):?>
        <a href="#"><div class="access-item">
          <div class="another-img">
            <img src="./pc/reco.png" height="60" width="60"/>
          </div>
          <div class="access-main"><!--
...
<div class="access">
  ...
  <div class="access-rank">
    <?php foreach($topics as $topic):?>
      <a href="#"><div class="access-item">
        <div class="another-img">
          <img src="./pc/face.png" height="60" width="60"/>
        </div>
        <div class="access-main"><!--
...
<div class="last">
  <div class="last-content">
    ...
    <div class="download">
      <a href="https://itunes.apple.com/jp/app/id884484921"><span><img src="./pc/apple.png" height="50" width="150"/></span></a>
      <a href="https://play.google.com/store/apps/details?id=jp.peroli.mery"><span><img src="./pc/android.png" height="50" width="150"/></span></a>
    </div>
  </div>
</div>
